...
function ObjectState() {
  return [
    ...
    { name: 'BisAI',       setter: setOpenProjectExpand, usestate: openProjectExpand, color: 'rgba(82, 117, 132, 0.85)', size: 'small' },
    { name: 'SEPMS',       setter: setOpenProjectExpand, usestate: openProjectExpand, color: 'rgba(114, 81, 54, 0.85)', size: 'small' },
    { name: 'Acadex',      setter: setOpenProjectExpand, usestate: openProjectExpand, color: 'rgba(65, 138, 68, 0.85)', size: 'small' },
    ...
    { name: 'Araaaz',      setter: setOpenProjectExpand,usestate: openProjectExpand,color: 'rgba(0, 159, 186, 0.85)', size: 'small' },
    { name: 'IE',          setter: setOpenProjectExpand,usestate: openProjectExpand,color: 'rgba(0, 159, 186, 0.85)', size: 'small' },
    { name: 'Raasta',      setter: setOpenProjectExpand,usestate: openProjectExpand,color: 'rgba(224, 88, 43, 0.85)', size: 'small' },
...
function handleShow(name) {
  ...
  allSetItems.forEach((item) => {
    ...
    if(itemName === lowerCaseName) {
      ...
      if(lowerCaseName === 'mail') clippySendemailfunction();
        if(lowerCaseName === 'winamp') clippySongFunction();
        if(lowerCaseName === 'msn') clippyUsernameFunction();
        if(lowerCaseName === 'bisai') {
          handleDoubleClickiframe('BisAI', setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe)
          handleShow('Internet');
        }
        if(lowerCaseName === 'sepms') {
          handleDoubleClickiframe('SEPMS', setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe)
          handleShow('Internet');
        }
        if(lowerCaseName === 'acadex') {
          handleDoubleClickiframe('Acadex', setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe)
          handleShow('Internet');
        }
        ...
        if(lowerCaseName === 'raasta') {
        handleDoubleClickiframe('Raasta', setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe)
        handleShow('Internet');
        }
        if(lowerCaseName === 'araaaz') {
        handleDoubleClickiframe('Araaaz', setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe)
        handleShow('Internet');
        }
        if(lowerCaseName === 'ie') {
  ...
  const notToOpenList = ['Run', 'BisAI', 'SEPMS', 'Acadex', 'AiAgent', '3dObject', 'Raasta', 'Bitcoin', 'Araaaz','IE'];
